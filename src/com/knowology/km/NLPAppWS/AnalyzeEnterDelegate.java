...
public interface AnalyzeEnterDelegate {
	...
	@RequestWrapper(localName = "reloadScenarios", targetNamespace = "http://knowology.com/", className = "com.knowology.km.NLPAppWS.ReloadScenarios")
	@ResponseWrapper(localName = "reloadScenariosResponse", targetNamespace = "http://knowology.com/", className = "com.knowology.km.NLPAppWS.ReloadScenariosResponse")
	public String reloadScenarios(
	 ...
	 */
	@WebMethod
	@RequestWrapper(localName = "addServiceInc", targetNamespace = "http://knowology.com/", className = "com.knowology.km.NLPAppWS.AddServiceInc")
	@ResponseWrapper(localName = "addServiceIncResponse", targetNamespace = "http://knowology.com/", className = "com.knowology.km.NLPAppWS.AddServiceIncResponse")
	public void addServiceInc(
			@WebParam(name = "arg0", targetNamespace = "") String arg0,
